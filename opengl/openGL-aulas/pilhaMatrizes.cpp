// pilhaMatrizes.cpp
// baseado em basicoTransformacaoDB.cpp

// Este programa demonstra o uso da pilha de matrizes para maior controle sobre as transformacoes
...
void RenderScene()
{
    // variavel estatica: assim como uma variavel global, mantem o valor entre as chamadas deste
    // procedimento
    ...
    // altera o angulo para a proxima vez que for desenhar
    angulo += 5;
...
int main(int argc, char* argv[])
{
    ...
    glutCreateWindow("Usando pilha de matrizes");
